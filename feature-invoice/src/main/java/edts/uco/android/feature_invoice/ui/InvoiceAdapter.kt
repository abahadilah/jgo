...
import edts.uco.android.feature_invoice.databinding.AdapterInvoicePeriodBinding
...
class InvoiceAdapter: BaseRecyclerView2()  {
    var delegate: InvoiceAdapterDelegate? = null
